...
import profileImg from "../assets/brother.jpeg";
  ...
  return (
    <div className="hero">
      ...
      >
        ...
        >
          <span>Designation:</span> Medical Student
        </motion.h3>
